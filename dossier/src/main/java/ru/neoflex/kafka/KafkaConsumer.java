...
public class KafkaConsumer {
    ...
    public ConsumerFactory<String, EmailMessage> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "ru.neoflex.*");
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    ConcurrentKafkaListenerContainerFactory<String, EmailMessage> emailMessageKafkaListenerContainerFactory() {
